// --------------------------------------------------------------
// Kode program untuk menghitung interpolasi clamped cubic spline
//      Oleh   : M. Ardhi K
...
data=[0.9,1.3,1.9,2.1,2.6,3,3.9,4.4,4.7,5,6,7,8,9.2,10.5,11.3,...
11.6,12,12.6,13,13.3;
1.3,1.5,1.85,2.1,2.6,2.7,2.4,2.15,2.05,2.1,2.25,2.3,2.25,1.94,1.4,0.9,...
0.7,0.6,0.5,0.4,0.25]

//nilai turunan f di x0 dan xn
fp0=0.5
fpn=0.4

//mendapatkan jumlah data dan nilai n
...
alpha(jumlahdata)=3*fpn-3*(a(jumlahdata)-a(n))/h(n)
l(jumlahdata)=h(n)*(2-mu(n))
z(jumlahdata)=(alpha(jumlahdata)-h(n)*z(n))/l(jumlahdata)
c(jumlahdata)=z(jumlahdata)
