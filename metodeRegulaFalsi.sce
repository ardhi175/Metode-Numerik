// -------------------------------------------------------------------------  
// Kode program untuk mencari akar dengan menggunakan metode Regula Falsi
//      Oleh   : M. Ardhi K
...
//Mulai proses pencarian akar dengan metode Regula Falsi
...
for i=1:maksimaliterasi
   ...
   if abs(y)<kriteriahenti then
       ...
       printf("Nilai p= %f\n",p)
       printf("Nilai f(p) = %f\n",y)
       if fungsiyangdicari(p0)*fungsiyangdicari(p)<0 then
           p0=p0
           p1=p
       else
           p0=p
